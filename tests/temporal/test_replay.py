...
That blind spot is a direct cost of the proxy design (see
poc/adapters/temporal/actor_proxy.py):
...
Regenerate the fixtures with `uv run python -m tests.temporal.record_histories` when the
